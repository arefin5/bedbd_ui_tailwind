...
export default function Page() {
  ...
  useEffect(() => {
    // Initialize the propertyCondition from localStorage or the current Redux state
    const localStorageData = JSON.parse(localStorage.getItem("data")) || {};
    setPropertyCondition(localStorageData.propertyCondition || currentFormData?.editlist?.propertyCondition || "");
  }, [currentFormData]);
