...
export default function Page() {
  ...
  useEffect(() => {
      // Safely access localStorage.data.amenities
  const localStorageData = JSON.parse(localStorage.getItem('data'));
  if (localStorageData && localStorageData.amenities) {
    setAmenities(localStorageData.amenities);
  ...
  // Update the amenities property within the data object
  localStorageData.amenities = updatedAmenities;
