...
// //         try {
// //             await axiosInstance.put(`/unfavoriteslist-list/${id}`);
// //             setIsFavorite(false);
// //             localStorage.setItem()
// //         } catch (error) {
...
//             // Update localStorage to reflect the new favorite
//             const updatedUser = { ...user, favoriteList: [...user.favoriteList, id] };
...
//             // Update localStorage to reflect the removal from favorites
//             const updatedUser = {
//                 ...user,
//                 favoriteList: user.favoriteList.filter(favId => favId !== id),
//             };
//             localStorage.setItem('user', JSON.stringify(updatedUser));
